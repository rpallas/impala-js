module.exports = {
  ...
  badImplementation: [{ statusCode: 500, error: "Internal Server Error", message: "An internal server error occurred" }],
  serviceUnavailable: [{ statusCode: 503, error: "Service Unavailable", message: "try again later" }],
